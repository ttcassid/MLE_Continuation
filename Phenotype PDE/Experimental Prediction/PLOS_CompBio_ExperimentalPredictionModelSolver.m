function [ModelValues] =  PLOS_CompBio_ExperimentalPredictionModelSolver(X,D,TimeVec);
...
%% Solve the untreated system
 ...
 Evalsol1Untreated = deval(sol1,WildTypeTime([1:4]),1)+ deval(sol1,WildTypeTime([1:4]),2);
 ...
 ModelValues = [log( Evalsol1Untreated )./log(10), log( EvalSol1Treated([3:end]) )./log(10)];
